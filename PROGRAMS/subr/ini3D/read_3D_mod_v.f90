...
do ips=1,2
	write(ps,'(i1)')ips
	open(1,file='../../../DATA/'//ar//'/'//md//'/data/dv_v'//ps//it//'.dat',form='unformatted',access='stream')
	!open(1,file='/media/baillard/Shared/Dropbox/_Moi/Projects/Axial/PROG/LOTOS_utilities/VGRID_x15_y15_z4_100m.lotos',&
	...
	write(*,*)' dv_3D(1,1,1,1)=',dv_3D(1,151,151,41)
	!pause
