subroutine prepare_model_att(ar,md,igr)
...
open(1,file='../../../DATA/'//ar//'/'//md//'/data/lev_att'//gr//'.dat')
i=0
722 i=i+1
...
ntop=0
open(1,file='../../../DATA/'//ar//'/'//md//'/data/gr_att'//gr//'.dat')
do n=1,nlev
...
open(1,file='../../../DATA/'//ar//'/'//md//'/data/obr_att'//gr//'.dat')
read(1,*) nobr
...
open(1,file='../../../DATA/'//ar//'/'//md//'/data/att_result_'//gr//'.dat')
do i=1,nobr
	read(1,*)  att_mod(i)
end do
close(1)
