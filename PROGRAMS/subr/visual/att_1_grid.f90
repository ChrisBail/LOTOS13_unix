subroutine att_1_grid(fff,ttt,zcur,smaxx,   att,umn)
...
897	continue
	...
	va1=0
	vb1=0
	if(ipop1.ne.0.and.irow.ne.1)va1=att_mod(ipop1)
	if(ipop2.ne.0.and.irow.ne.1)vb1=att_mod(ipop2)
...
898	continue
	...
	va2=0
	vb2=0
	if(ipop1.ne.0.and.irow.ne.nrow-1)va2=att_mod(ipop1)
	if(ipop2.ne.0.and.irow.ne.nrow-1)vb2=att_mod(ipop2)
...
att =dvv(1)+((dvv(2)-dvv(1))/(y2-y1))*(ycur-y1)
