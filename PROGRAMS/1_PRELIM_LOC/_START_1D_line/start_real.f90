...
do iter=1,niter	
	...
	i=system('..\..\1_PRELIM_LOC\_1_loc_line\loc_1D.exe')

	write(*,*)'	 ****************************************************'
	write(*,*)'	 Matrix calculation:'
	i=system('..\..\1_PRELIM_LOC\_2_matr_line\matr.exe')

	write(*,*)'	 ****************************************************'
	write(*,*)'	 Inversion:'
	i=system('..\..\1_PRELIM_LOC\_3_invers_line\invers.exe')
    stop
...
open(11,file='../../../PICS/'//ar//'/'//md//'/1d_info.dat')
do i=1,niter
