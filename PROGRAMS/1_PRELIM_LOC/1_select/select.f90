...
do iz=1,1000
	...
	z1=zmin+(iz-1)*dzstep
	z2=zmin+iz*dzstep
    !write(*,*)' iz=',iz,' z1=',z1,' z2=',z2
	write(*,'(f6.1,100i4)')z1,(nkr_z(iz,im),im=1,nmx_z(iz))
end do
...
nray=0
open(1,file='../../../DATA/'//ar//'/'//md//'/data/rays0.dat',form='unformatted',access='stream')
open(11,file='../../../DATA/'//ar//'/'//md//'/data/rays_selected.dat',form='unformatted',access='stream',status='replace')
