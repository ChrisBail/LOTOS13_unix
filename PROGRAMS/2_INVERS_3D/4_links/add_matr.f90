...
do iiips=1,2
    ...
    open(12,file='../../../DATA/'//ar//'/'//md//'/data/link_hor'//ppss//gr//'.dat',form='unformatted',access='stream')
    write(12)ilink
    do i=1,ilink
    ...
    open(12,file='../../../DATA/'//ar//'/'//md//'/data/link_ver'//ppss//gr//'.dat',form='unformatted',access='stream')
    write(12)ilink
    do i=1,ilink
	    write(12)links(1,i),links(2,i)
    end do
