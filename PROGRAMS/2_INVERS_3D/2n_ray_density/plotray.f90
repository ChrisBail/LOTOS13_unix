...
!write(*,*)xlim1,xlim2,dxpl, ylim1,ylim2,dypl, zlim1,zlim2,dzpl CB
...
open(1,file='../../../DATA/'//ar//'/'//md//'/data/rays'//it//'.dat',form='unformatted',access='stream') !CB
open(2,file='../../../TMP_files/tmp/ray_paths_'//it//'.dat',form='unformatted',access='stream') !CB
...
728 continue
        ...
        do ikr=1,nkrat
                ...
                do i=1,npray
                        ...
                        !write(*,*) xray4(i),yray4(i),zray4(i) !CB
                end do
...
do iiips=1,2
	...
	write(ppss,'(i1)')iiips
        open(12,file='../../../TMP_files/tmp/plotray'//ppss//gr//'.dat',form='unformatted',access='stream') !CB
	do iy=1,nypl
