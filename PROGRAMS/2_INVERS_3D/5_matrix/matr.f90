...
do iiips=1,2
    ...
    do iy=1,nypl
        ...
        do inod=1,ntop(iy,iiips)
            ...
            vtop(inod,iy,iiips)=velocity(xx,yy,zz,iiips) ! Be sure to use the proper velocity CB
        end do
    end do
    close(1)
...
open(11,file='../../../TMP_files/tmp/matr'//it//gr//'.dat',form='unformatted',access='stream')
...
nr=0
open(1,file='../../../DATA/'//ar//'/'//md//'/data/rays'//it//'.dat',form='unformatted',access='stream')
open(2,file='../../../TMP_files/tmp/ray_paths_'//it//'.dat',form='unformatted',access='stream')
    ...
    !        end do
            do i8=1,8
                ...
                if(abs(xnod8(3)-xnod8(1)).lt.0.00001)then
                    ...
                    write(*,*)' kall_xy(ix11,nur1,1,ips)',kall_xy(ix11,nur1,1,ips)
                    write(*,*)' kall_xy(ix21,nur1,1,ips)',kall_xy(ix21,nur1,1,ips)
        ...
        !write(*,*) nuz,res,ist,ips,nzt !CB
        !write(*,*) dtdx,dtdy,dtdz !CB
